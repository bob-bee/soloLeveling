...
async def save_chapter_as_pdf(chapter_folder: Path, chapter_number: str, url: str, format="A4"):
    """
    Save the chapter from the URL as a PDF in the same folder as the text file.
    """
...
async def process_chapter_folder(chapter_folder: Path):
    """
    Process each .txt file inside the chapter folder and generate a PDF in the same folder.
    """
...
async def main():
    """
    Process all chapter folders in the output directory and generate PDFs.
    """
